                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="88%" style="width: 88% !important; min-width: 88%; max-width: 88%;">
                            <tr>
                                <td align="left" valign="top">
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#B4A53F" style="font-size: 30px; line-height: 60px; font-weight: bolder; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #B4A53F; font-size: 30px; line-height: 60px; font-weight: bolder; letter-spacing: -1.5px;">{{env('APP_NAME')}}</span>
                                    </font>
                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 25px; line-height: 60px; font-weight: bolder; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 25px; line-height: 60px; font-weight: bolder; letter-spacing: -1.5px;">Hi, {{$user->name}}</span>
                                    </font>
                                    <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                    <font face="'Source Sans Pro', sans-serif" color="#585858" style="font-size: 24px; line-height: 20px;">
