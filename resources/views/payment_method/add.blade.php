                    ...
                    <div class="row">
                        <div class="col-sm-8 offset-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input id="card_number" type="text" placeholder="Card Number" class="form-control @error('card_number') is-invalid @enderror" name="card_number" required value="{{ old('card_number') }}" autocomplete="card_number">
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <p>By click on this Add Card button you're agreed to the <a href="https://terryconsulting.clickfunnels.com/terms3rzrxz34" target="_blank" class="text-rose">Terms of Agreement</a>.</p>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-rose" id="add-btn">Add Card</button>
                                    </div>
                                </div>
