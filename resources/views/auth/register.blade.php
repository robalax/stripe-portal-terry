                ...
                <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="card card-login card-hidden">
                            ...
                            <div class="card-body ">
                                <p class="text-center">
                                    <strong>Note:</strong> Note: Please be sure to use the same email that you used to purchase the Business Accelerator Group. If you are unsure what email address that is - please reach out to info@terryfosterconsulting.com.
                                </p>
                    ...
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control" name="password_confirmation" placeholder="Confirm Password">
                            ...
                            <div class="card-footer justify-content-center">
                                <button type="submit" class="btn btn-rose btn-lg">Register</button>
                            </div>
                        </div>
                    </form>
                </div>
